...
import com.lakhmotkin.rabocsv.repository.service.CardsApiClient;
import com.lakhmotkin.rabocsv.repository.service.CardsClient;
import com.lakhmotkin.rabocsv.repository.service.CardsClientType;
...
public class CardsListViewModelTest {
    ...
    private final List<Issue> MANY_Issues = Arrays.asList(new Issue("CS2_041e"), new Issue("HERO_09"), new Issue("EX1_399e"));
    ...
    public void shouldPassProducts() {
        when(mRepository.fetchRemoteCards()).thenReturn(Observable.just(MANY_Issues));
    ...
    public void shouldShowError() {
        ...
        TestObserver<List<Issue>> subscriber = testRepository
                .fetchRemoteCards()
                .test();
